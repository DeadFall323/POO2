...
################################################################################
## Form generated from reading UI file 'Tela_redefinir_senhaXIbSIw.ui'
##
...
class Ui_Ui_tela_login_redefinir_senha(object):
    def setupUi(self, Ui_tela_login_redefinir_senha):
        if Ui_tela_login_redefinir_senha.objectName():
            Ui_tela_login_redefinir_senha.setObjectName(u"Ui_tela_login_redefinir_senha")
        Ui_tela_login_redefinir_senha.resize(908, 703)
        Ui_tela_login_redefinir_senha.setUnifiedTitleAndToolBarOnMac(True)
        self.centralwidget = QWidget(Ui_tela_login_redefinir_senha)
...
"")
        ...
        Ui_tela_login_redefinir_senha.setCentralWidget(self.centralwidget)

        self.retranslateUi(Ui_tela_login_redefinir_senha)

        QMetaObject.connectSlotsByName(Ui_tela_login_redefinir_senha)
    # setupUi

    def retranslateUi(self, Ui_tela_login_redefinir_senha):
        Ui_tela_login_redefinir_senha.setWindowTitle(QCoreApplication.translate("Ui_tela_login_redefinir_senha", u"Jogue Agora", None))
        self.label.setText(QCoreApplication.translate("Ui_tela_login_redefinir_senha", u"Bem vindo a tela de recupera\u00e7\u00e3o de senha", None))
        self.label_3.setText(QCoreApplication.translate("Ui_tela_login_redefinir_senha", u"Primeiro informe seu email cadastrado", None))
        self.label_2.setText(QCoreApplication.translate("Ui_tela_login_redefinir_senha", u"Email:", None))
        self.pushButton_2.setText(QCoreApplication.translate("Ui_tela_login_redefinir_senha", u"Verifique", None))
        self.pushButton_3.setText(QCoreApplication.translate("Ui_tela_login_redefinir_senha", u"Cancelar", None))
    # retranslateUi
